...
public class UsSettingsActivity extends AppCompatActivity {
    ...
    private void onClick() {
        clSunting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UsSettingsActivity.this, UsEditProfileActivity.class);
        ...
        clGantiPass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UsSettingsActivity.this, ChangePasswordActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void showKeluarDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(UsSettingsActivity.this);
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(UsSettingsActivity.this, LoginActivity.class);
