...
public class OnlineSoalModel implements Parcelable {
    long dateCreated;
    String soal, jwbA, jwbB, jwbC, jwbD, jwbE, jawabanBenar, documentId;

    public OnlineSoalModel() {
    }

    public OnlineSoalModel(long dateCreated, String soal, String jwbA, String jwbB, String jwbC, String jwbD, String jwbE, String jawabanBenar) {
    ...
    protected OnlineSoalModel(Parcel in) {
    ...
    public static final Creator<OnlineSoalModel> CREATOR = new Creator<OnlineSoalModel>() {
        @Override
        public OnlineSoalModel createFromParcel(Parcel in) {
            return new OnlineSoalModel(in);
        }

        @Override
        public OnlineSoalModel[] newArray(int size) {
            return new OnlineSoalModel[size];
        }
    };
