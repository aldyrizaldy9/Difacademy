...
import com.example.aldy.difacademy.Adapter.VideoBlendedAdapter;
...
public class ListVideoBlendedActivity extends AppCompatActivity {
    ...
    private void onClick() {
        ...
        clQuiz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (IS_PAID) {
                    Intent intent = new Intent(ListVideoBlendedActivity.this, QuizActivity.class);
                    intent.putExtra("jenisKelas", jenisKelas);
                    intent.putExtra("materiModel", materiModel);
                    startActivity(intent);
                } else {
                    Toast.makeText(ListVideoBlendedActivity.this, "Anda belum membeli materi ini!", Toast.LENGTH_SHORT).show();
                }
            }
        });
