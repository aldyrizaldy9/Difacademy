...
public class OpAddOnlineMateriActivity extends AppCompatActivity {
    ...
    OnlineMateriModel onlineMateriModel, oldOnlineMateriModel;
    Uri imageUri;
    String thumbnailUrl = "";
    int index;
    long dateCreated = 0;
    ...
    private void checkIntent() {
        ...
        onlineMateriModel = intent.getParcelableExtra("online_materi_model");
        if (onlineMateriModel != null) {
            oldOnlineMateriModel = onlineMateriModel;
            index = intent.getIntExtra("index", -1);
            thereIsData = true;
            thumbnailUrl = onlineMateriModel.getThumbnailUrl();
            btnHapus.setVisibility(View.VISIBLE);
            Glide.with(this)
                    .load(thumbnailUrl)
                    .into(imgThumbnail);
            edtJudul.setText(onlineMateriModel.getTitle());
            onlineMateriDocId = onlineMateriModel.getDocumentId();
            Log.d(TAG, "checkIntent: onlinemateridocid : " + onlineMateriDocId);
        }
    }
        ...
        btnAddVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isDataComplete()) {
                    ...
                    if (thereIsData) {
                        if (title.equals(oldOnlineMateriModel.getTitle()) && imageUri == null) {
    ...
    private void simpanMateri() {
        ...
        OnlineMateriModel model = new OnlineMateriModel(title, thumbnailUrl, dateCreated);
    ...
    private void editMateri(final OnlineMateriModel model) {
    ...
    private void tambahMateri(final OnlineMateriModel model) {
    ...
    private void deletePhotoInFirebase(final OnlineMateriModel model) {
        StorageReference deleteRef = firebaseStorage.getReferenceFromUrl(oldOnlineMateriModel.getThumbnailUrl());
        deleteRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
